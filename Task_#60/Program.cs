/*ЗЗадача 60. ...Сформируйте трёхмерный массив из неповторяющихся двузначных чисел. 
...
int[,,] CreateMatrix(int size1, int size2, int size3)
{
...
int[,,] resultNums = CreateMatrix(deep1, deep2, deep3);
